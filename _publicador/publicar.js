 ...
 * Gera HTMLs nas subpastas contos/, ensaios/, cronicas/, notas/
 */
...
const CONFIG = {
  ...
  // Subpastas de destino dos HTMLs gerados
  subpastas: {
    contos:   'contos',
    ensaios:  'ensaios',
    cronicas: 'cronicas',
...
<script>initLayout('${ativo}', false);</script>
...
for (const [secao, pastaTxt] of Object.entries(CONFIG.rascunhos)) {
  ...
  for (const nomeArquivo of txts) {
    ...
    try {
      ...
      // href relativo à raiz para o índice
